...
function beep() {
	return document.getElementById("jukebox").innerHTML="<embed src='music/music.mp3' hidden=true autostart=true loop=false>";	
}
...
xmlhttp.open("GET","stud_det_qr.php?id="+str,true);
xmlhttp.send();
}    
